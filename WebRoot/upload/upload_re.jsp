...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		if(window.parent.document.getElementById("fujian").value==''||window.parent.document.getElementById("fujian").value==null){
		 ...
		 window.parent.document.getElementById("fujianYuanshiming").value="<s:property value='#request.oldFujianName'/>";
		     ...
		     window.parent.document.getElementById("erweima").value="<s:property value='#request.fujianPath'/>";
		     }
		</script>
   </body>
</html>
